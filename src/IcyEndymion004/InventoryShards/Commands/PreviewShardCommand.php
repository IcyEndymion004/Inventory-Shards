...
class PreviewShardCommand extends Command {

    public function __construct()
    {
        parent::__construct("previewshard", "Preview A Shards Items", "/previewshard {shard}", []);
        $this->setPermission("inventory.shards.command.preview");
    }
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args)
    {
        ...
        Utils::Preview_Shard_Gui($sender, $args[0]);
    }
}